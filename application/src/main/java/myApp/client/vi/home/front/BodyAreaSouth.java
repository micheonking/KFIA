...
//		redButton.setText("공지사항");
		...
		HorizontalLayoutData rowLayout1 = new HorizontalLayoutData(0.25, 1, new Margins(2, 400, 0, 10));	// Double Column Size
		HorizontalLayoutData rowLayout2 = new HorizontalLayoutData(0.25, 160, new Margins(20, 0, 0, 0));	// Double Column Size

		SafeHtml button1Html = SafeHtmlUtils.fromTrustedString("<left><font color='#606060' style='font-size:18px;'><p style='font-weight:bold;'><br>공지사항</p></font>");
		SafeHtml button2Html = SafeHtmlUtils.fromTrustedString("<left><font color='#606060' style='font-size:18px;'><p style='font-weight:bold;'><br>보도자료</p></font>");
