...
public class Sys10_Lookup_MultiFile2 extends VerticalLayoutContainer {
	...
	public Sys10_Lookup_MultiFile2() {
		makeLayout();
	}
	
	public Sys10_Lookup_MultiFile2(Long parentId, String editYn, int height) {
